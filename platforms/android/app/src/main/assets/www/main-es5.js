...
var map = {
	"../home/home.module": [
		...
		"default~components-chat-chat-module~components-message-message-module~components-post-post-module~ho~b6f0fa38",
		"home-home-module"
	],
	...
	"../user-profile/user-profile.module": [
		...
		"default~components-chat-chat-module~components-message-message-module~components-post-post-module~ho~b6f0fa38",
		"default~components-post-post-module~user-profile-user-profile-module",
		"user-profile-user-profile-module"
	],
	...
	"./components/message/message.module": [
...
var routes = [
    ...
    { path: 'login', loadChildren: function () { return __webpack_require__.e(/*! import() | components-login-login-module */ "components-login-login-module").then(__webpack_require__.bind(null, /*! ./components/login/login.module */ "./src/app/components/login/login.module.ts")).then(function (m) { return m.LoginPageModule; }); } },
...
var AppComponent = /** @class */ (function () {
    function AppComponent(platform, splashScreen, statusBar, storage, oneSignal, navctrl) {
    ...
    AppComponent.prototype.initializeApp = function () {
        ...
        this.platform.ready().then(function (res) {
            ...
            _this.statusBar.backgroundColorByHexString('#3E3D3B');
            _this.splashScreen.hide();
            if (res == 'cordova') {
                _this.oneSignal.startInit('e194af8d-50b1-4150-958d-afb0df854256', '300836949208');
                _this.oneSignal.getIds().then(function (res) {
                    _this.storage.set('ids', res);
                ...
                _this.oneSignal.handleNotificationOpened().subscribe(function (res) {
                    _this.navctrl.navigateForward('NotificationPage');
                });
    ...
    AppComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            ...
            providers: [_ionic_native_onesignal_ngx__WEBPACK_IMPORTED_MODULE_6__["OneSignal"]],
...
/* harmony import */ var _services_pushnotification_servics__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./services/pushnotification.servics */ "./src/app/services/pushnotification.servics.ts");
...
/* harmony import */ var angular2_moment_moment_module__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! angular2-moment/moment.module */ "./node_modules/angular2-moment/moment.module.js");
/* harmony import */ var angular2_moment_moment_module__WEBPACK_IMPORTED_MODULE_16___default = /*#__PURE__*/__webpack_require__.n(angular2_moment_moment_module__WEBPACK_IMPORTED_MODULE_16__);
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            imports: [
                ...
                angularfire2__WEBPACK_IMPORTED_MODULE_12__["AngularFireModule"].initializeApp(_environments_environment__WEBPACK_IMPORTED_MODULE_9__["environment"].firebase),
                ...
                angular2_moment_moment_module__WEBPACK_IMPORTED_MODULE_16__["MomentModule"],
                _ionic_storage__WEBPACK_IMPORTED_MODULE_15__["IonicStorageModule"].forRoot()
            ],
            providers: [
                _ionic_native_status_bar_ngx__WEBPACK_IMPORTED_MODULE_6__["StatusBar"],
                _ionic_native_splash_screen_ngx__WEBPACK_IMPORTED_MODULE_5__["SplashScreen"],
                _services_pushnotification_servics__WEBPACK_IMPORTED_MODULE_11__["PushNotificationService"],
...
/***/ "./src/app/services/pushnotification.servics.ts":
/*!******************************************************!*\
  !*** ./src/app/services/pushnotification.servics.ts ***!
  \******************************************************/
...
var PushNotificationService = /** @class */ (function () {
    ...
    PushNotificationService.prototype.sendNotification = function (message) {
        ...
        return this.http.post(this.url, body, { headers: headers })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (data) { return data.json(); }));
...
module.exports = __webpack_require__(/*! /home/contriverz1/Downloads/ionic3_to_ionic4/src/main.ts */"./src/main.ts");
